 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.profileapp.staging
 */

const BUNDLE_ID = 'com.profileapp'; // ios bundle id
const PACKAGE = 'com.profileapp'; // android package name
const NAME = 'ProfileApp'; // app name
